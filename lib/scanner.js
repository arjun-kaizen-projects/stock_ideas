...
Universal pattern: a company building a new platform from near-zero revenue with committed customer demand, massive intentional capex, and a clear capacity utilization ramp visible ahead.
Original example: Nebius — GPU/AI cloud infrastructure built from scratch with hyperscaler-grade H100 clusters and early enterprise traction.
...
Return ONLY valid JSON (no markdown fences):
{
  ...
  "archetypeBreakdowns": {
    ...
    "nebius": {
      ...
      "committedCapex":         <0-25, committed spend on buildout with visible demand>,
      "aiEngineeringDepth":     <0-20, leadership or team pedigree, technical moat>,
      "enterpriseTraction":     <0-15, early paying customers or committed offtake>,
      "infrastructureMoat":     <0-15, unique positioning or barrier to replication>,
      "keySignal": "<one sentence: strongest Archetype 3 evidence in this filing, or why it does not match>"
    }
  },
...
async function runDailyScan() {
  ...
  console.log(`[${new Date().toISOString()}] SEC scan starting (last 7 days)…`);
